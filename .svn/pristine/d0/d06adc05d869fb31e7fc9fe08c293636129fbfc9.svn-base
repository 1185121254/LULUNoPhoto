...
@interface KNewSelect ()<UITableViewDataSource,UITableViewDelegate>
{
    UIView *_viewForg;
}
@end

@implementation KNewSelect
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (_arrNewData.count >0) {
        dic = [NSMutableDictionary dictionaryWithDictionary:_arrNewData[indexPath.row]];
    }

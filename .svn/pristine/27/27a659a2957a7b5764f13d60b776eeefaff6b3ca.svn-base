...
//    [dicData setObject:checkList forKey:@"checkList"];
    ...
    [alter addAction:[UIAlertAction actionWithTitle:@"确定" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        ...
        [RequestManager postWithURLStringALL:[NSString stringWithFormat:@"%@/api/Share/DiagnosisAdviceAdd",NET_URLSTRING] heads:DICTIONARY_VERIFYCODE parameters:dicData viewConroller:self success:^(id responseObject, BOOL ifTimeout) {

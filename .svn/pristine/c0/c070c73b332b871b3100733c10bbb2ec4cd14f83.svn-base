...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        [_btnOutTime setTitle:@"已超时" forState:UIControlStateNormal];
        _btnOutTime.hidden = YES;
        [self.contentView addSubview:_btnOutTime];
        
        _lblName = [[UILabel alloc]initWithFrame:CGRectMake(79, 10, kWith-79-80-50, 20)];
...
-(void)onBtnCall:(UIButton *)btn{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"callNow" object:self];

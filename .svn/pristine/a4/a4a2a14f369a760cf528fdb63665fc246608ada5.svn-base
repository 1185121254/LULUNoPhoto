...
@interface ArtificialCrystalUIView ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation ArtificialCrystalUIView
...
-(void)getTableviewData
{
    ...
    //获取需要上传的数据
    //GET
    [RequestManager getWithURLString:ARTIFICAL_CRYSTAL heads:heads parameters:nil success:^(id responseObject)
     {

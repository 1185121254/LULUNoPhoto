...
- (void)viewDidLoad {
    ...
    _tableView = [[UITableView alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(viewBottom.frame), kWith, kHeight-CGRectGetMaxY(viewBottom.frame)) style:UITableViewStyleGrouped];
    ...
    [RequestManager getWithURLStringALL:[NSString stringWithFormat:@"%@/api/Share/GetVasConsultation",NET_URLSTRING] heads:DICTIONARY_VERIFYCODE parameters:dic viewConroller:self success:^(id responseObject) {
        ...
        _lblIdCard.text = [NSString stringWithFormat:@"身份证号：%@",_patientModel.idCard];
        _lblPhoneNum.text = [NSString stringWithFormat:@"电话号码：%@",_patientModel.tel];
...
-(void)setHeader{
    ...
    viewBottom = [[UIView alloc]initWithFrame:CGRectMake(0, 60, kWith, 90)];
    ...
    UILabel *lblName = [[UILabel alloc]initWithFrame:CGRectMake(70, 15, kWith-80, 20)];
    ...
    _lblIdCard = [[UILabel alloc]initWithFrame:CGRectMake(70, 39, kWith-80, 20)];
    _lblIdCard.textColor = [UIColor whiteColor];
    _lblIdCard.font = [UIFont systemFontOfSize:14];
    [viewBottom addSubview:_lblIdCard];
    
    _lblPhoneNum  = [[UILabel alloc]initWithFrame:CGRectMake(70, 61, kWith, 20)];
    _lblPhoneNum.font = [UIFont systemFontOfSize:14];
    _lblPhoneNum.textColor = [UIColor whiteColor];
    [viewBottom addSubview:_lblPhoneNum];
}
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    UILabel *lbl = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, kWith, 30)];
...
-(NSMutableAttributedString *)setText:(NSString *)text{
    ...
    [medStr addAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:14]} range:[text rangeOfString:strUnit]];
    return medStr;
}

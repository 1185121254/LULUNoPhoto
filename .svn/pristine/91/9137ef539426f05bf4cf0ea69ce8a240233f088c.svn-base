...
-(void)onBtnSearchDocAddvice{
    ...
    if ([self.from isEqualToString:@"drug"]) {
        [RequestManager postWithURLStringALL:[NSString stringWithFormat:@"%@/api/Doctor/GetAdviceDrug",NET_URLSTRING] heads:DICTIONARY_VERIFYCODE parameters:dic viewConroller:self success:^(id responseObject, BOOL ifTimeout) {
    ...
    {
        [RequestManager postWithURLStringALL:[NSString stringWithFormat:@"%@/api/Doctor/GetAdviceCheck",NET_URLSTRING] heads:DICTIONARY_VERIFYCODE parameters:dic viewConroller:self success:^(id responseObject, BOOL ifTimeout) {

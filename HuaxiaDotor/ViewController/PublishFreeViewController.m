...
- (void)viewDidLoad {
    ...
    for (NSInteger i = 0; i< 40; i++) {
        [_arryPickView addObject:[NSString stringWithFormat:@"%d",i+1]];
    }
...
-(void)onPublish:(UIButton *)sender{
    ...
    if (_selectedBtn != 777+2) {
        ...
        [RequestManager postWithURLStringALL:[NSString stringWithFormat:@"%@/api/Share/FreeClinicAdd",NET_URLSTRING] heads:DICTIONARY_VERIFYCODE parameters:dic viewConroller:self success:^(id responseObject, BOOL ifTimeout) {

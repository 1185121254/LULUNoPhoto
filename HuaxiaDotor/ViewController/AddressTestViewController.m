...
- (void)viewDidLoad {
    ...
    [RequestManager getWithURLStringALL:[NSString stringWithFormat:@"%@/api/Circle/CircleFriendInfo",NET_URLSTRING] heads:DICTIONARY_VERIFYCODE parameters:dic viewConroller:self success:^(id responseObject) {
...
-(void)onAddressTestAgree:(NSNotification *)notify{
    ...
    [RequestManager postWithURLStringALL:[NSString stringWithFormat:@"%@/api/Circle/CircleFriendValidate",NET_URLSTRING] heads:DICTIONARY_VERIFYCODE parameters:dic viewConroller:self success:^(id responseObject, BOOL ifTimeout) {

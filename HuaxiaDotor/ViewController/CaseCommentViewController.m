...
-(void)viewWillAppear:(BOOL)animated{
    ...
    [RequestManager getWithURLStringALL:[NSString stringWithFormat:@"%@/api/Doctor/DiscussionDetailFind",NET_URLSTRING] heads:DICTIONARY_VERIFYCODE parameters:dic viewConroller:self success:^(id responseObject) {
        _dicCom = (NSDictionary *)responseObject;;
...
-(void)onBTnPerClivk{
    ...
    [RequestManager getWithURLStringALL:[NSString stringWithFormat:@"%@/api/Doctor/DiscussionDetailFind",NET_URLSTRING] heads:DICTIONARY_VERIFYCODE parameters:dic viewConroller:self success:^(id responseObject) {
        ...
        NSDictionary *dicCom = (NSDictionary *)responseObject;
...
-(void)onBTnPerClivkDetail{
    ...
    [RequestManager getWithURLStringALL:[NSString stringWithFormat:@"%@/api/Doctor/DiscussionDetailFind",NET_URLSTRING] heads:DICTIONARY_VERIFYCODE parameters:dic viewConroller:self success:^(id responseObject) {
        ...
        comm.dicData = (NSDictionary *)responseObject;

...
-(void)addPhonePaiBan{
    ...
    [RequestManager postWithURLStringALL:[NSString stringWithFormat:@"%@/api/Share/VasDutyRosterSet",NET_URLSTRING] heads:DICTIONARY_VERIFYCODE parameters:paramts viewConroller:self success:^(id responseObject, BOOL ifTimeout) {

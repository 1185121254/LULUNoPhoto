...
-(void)sendSelectImage:(UIImage *)image
{
    ...
    [RequestManager CasePicWithURLString:[NSString stringWithFormat:@"%@/api/Share/PictureUpload",NET_URLSTRING] heads:header Parameters:imageDataArry  viewConroller:self Complation:^(NSDictionary *dicCom) {
...
//    [manager.requestSerializer setValue:@"application/json; charset=utf-8" forHTTPHeaderField:@"Content-Type"];
    ...
    [RequestManager postWithURLStringALL:DOCTORAPPROVEPOST heads:DICTIONARY_VERIFYCODE parameters:parameters viewConroller:self success:^(id responseObject, BOOL ifTimeout) {

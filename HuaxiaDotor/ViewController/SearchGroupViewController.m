...
-(void)onBtnSearchGroup{
    ...
    [RequestManager getWithURLStringALL:[NSString stringWithFormat:@"%@/api/Doctor/GetPatientByDoc",NET_URLSTRING] heads:DICTIONARY_VERIFYCODE parameters:dic viewConroller:self success:^(id responseObject) {

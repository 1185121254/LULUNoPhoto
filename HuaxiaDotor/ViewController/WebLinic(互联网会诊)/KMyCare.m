...
@interface KMyCare ()<UITableViewDataSource,UITableViewDelegate>

@end

@implementation KMyCare
...
-(void)getNetConsultationListFindAndPage:(NSNumber*)Page andRow:(NSNumber*)Row andUPorDown:(BOOL)Up
{
    ...
    //GET
    [RequestManager getWithURLString:NETCONSULTATIONJOINLISTFIND heads:heads parameters:parameters success:^(id responseObject)
     {

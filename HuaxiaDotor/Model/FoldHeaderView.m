...
- (NSMutableAttributedString *)attributeStringWith:(NSString *)money
{
    ...
    [ats setAttributes:@{NSForegroundColorAttributeName:[UIColor colorWithWhite:0.000 alpha:0.297]} range:range];
    [ats addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:9] range:range];
    return ats;
}
...
- (void)creatUI
{
    ...
    //其他内容
    _detailLabel = [[UILabel alloc] initWithFrame:CGRectMake(120, 2, 320-40, 30)];

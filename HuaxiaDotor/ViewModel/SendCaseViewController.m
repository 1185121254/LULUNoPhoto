...
@interface SendCaseViewController ()<UITextViewDelegate,UIScrollViewDelegate,ViewSendImageArrDelegate>
{
...
@implementation SendCaseViewController
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    self.navigationController.title = @"发布病例";
}
...
- (void)viewDidLoad
{
    ...
    self.view.frame=CGRectMake(0, 0, kWith, kHeight+49);
    self.selfView.backgroundColor=[UIColor colorWithWhite:0.500 alpha:0.047];
...
- (IBAction)sendCase:(UIButton *)sender
{
    //判断标题和内容是否为空
...
-(void)sendPOSTdata
{
    ...
    [manager.requestSerializer setValue:[@"1" stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding] forHTTPHeaderField:@"type"];
